...
import { fetchSinglePosts } from "@/app/store/product/productSlice";
import { addToCart } from "@/app/store/cart/cartSlice";
interface propsdata {
  params: any;
}
const Singleproduct: React.FC<propsdata> = ({ params }) => {
  const data: any = useSelector(
    (state: any) => state.product.singleProduct.STATUS_RESPONSE
  );
  let roundedDown = Math.floor(data?.rating);
  ...
  useEffect(() => {
    dispatch(fetchSinglePosts(params.id));
    return () => {};
  }, []);
  ...
  return (
    <>
      <div className="h-[100vh]">
        <section className="h-full text-gray-400 bg-gray-900 body-font overflow-hidden">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mb-4">
                  <span className="flex items-center">
                    ...
                    <span className="ml-3">{data?.reviews} Reviews</span>
                  </span>
